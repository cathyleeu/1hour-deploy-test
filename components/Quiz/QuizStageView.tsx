    ...
    <section>
      <div className="flex justify-between items-center mb-10">
        <p className="text-2xl font-bold">
          <span className="text-blue">#UserName</span>을 위해 문제를 랜덤으로 총 10개를 준비했어요.
          <br />
          문제를 풀며 자가진단을 해보세요!
        </p>
      ...
      <div className="flex flex-col gap-4 relative">
        <QuestionCard maxStage={QUIZ_NUM} stage={currentStage + 1} question={quiz?.question} />
        ...
        <Button className="font-bold p-4 px-6 self-end bg-blue" onClick={handleNextStage}>
          다음 문제
        </Button>
      </div>
