...
export const oneHourUrl = {
  ...
  GET_QNA: 'http://localhost:3000/api/qna',
  ...
  // TOGGLE_BOOKMARK: (uid:string, id:string) => `http://localhost:3000/api/favor/${uid}/bookmarks/${id}`,
  GET_USER_LIKES: (uid:string) => `http://localhost:3000/api/favor/${uid}/likes`,
  // TOGGLE_LIKES: (uid:string, id:string) => `http://localhost:3000/api/favor/${uid}/likes/${id}`,
